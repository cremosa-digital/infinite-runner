...
let menu = {
    ...
    draw: function () {
        ...
        if (actualState === states.start) {
            ...
            context.font = '10px OceanRush';
            if (language === 'pt-br') {
                context.fillText('Desenvolvido por Cremosa         _digital', this.secondTextX - 3, this.secondTextY + 30);
            } else if (language === 'en-us') {
                context.fillText('Developed by Cremosa          _digital', this.secondTextX - 3, this.secondTextY + 30);
            }
            ...
            context.font = '14px OceanRush';
            context.fillText('cremosa        _digital', this.thirdTextX + 40, this.thirdTextY + 50);
